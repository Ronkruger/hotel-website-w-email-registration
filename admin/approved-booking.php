    ...
    <div class="booking-container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped table-hover js-dataTable-full-pagination">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT tbluser.*,tblbooking.BookingNumber,tblbooking.Status,tblbooking.BookingDate 
                                FROM tblbooking 
                            ...
                            foreach ($results as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        $status = $row->Status;
                                        if ($status == '') { ?>
                                            <span class="badge bg-warning"><?php echo htmlentities('Not Updated Yet'); ?></span>
                                    ...
                                    <td>
                                        <a href="view-booking-detail.php?bookingid=<?php echo htmlentities($row->BookingNumber); ?>" class="btn btn-info btn-sm">View Details</a>
                                    </td>
                                </tr>
                            <?php $cnt++;
                            }
